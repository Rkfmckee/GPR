...
public class TrapLinkingLine : MonoBehaviour
{
	...
	{
		var firstTrap     = firstBeingLinked.GetComponent<TrapController>();
		var firstTrigger  = firstBeingLinked.GetComponent<TriggerController>();
		var secondTrap    = secondBeingLinked.GetComponent<TrapController>();
		var secondTrigger = secondBeingLinked.GetComponent<TriggerController>();
