...
public class CanvasController : MonoBehaviour
{
	...
	public void SetCraftingMenuVisible(bool visible, CraftingStation craftingStation = null)
	{
		...
		else
		{
			if (craftingMenu != null)
			{
				...
				craftingMenu                      = null;
				cameraController.ControllingState = CameraControllingState.ControllingSelf;
	...
	public void EnableActionText(Dictionary<CameraControllingState, List<string>> statesAndUiText)
	{
		if (!statesAndUiText.ContainsKey(cameraController.ControllingState))
		{
			return;
		}

		var actionTextForCurrentState = statesAndUiText[cameraController.ControllingState];
	...
	public void DisableActionText(Dictionary<CameraControllingState, List<string>> statesAndUiText)
	{
		if (!statesAndUiText.ContainsKey(cameraController.ControllingState))
		{
			return;
