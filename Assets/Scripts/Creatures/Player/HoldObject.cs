...
public class HoldObject : MonoBehaviour {
    ...
    private PickUpObject heldObjectController;
    ...
    public void SetHeldObject(GameObject objectHeld) {
        ...
        heldObjectController = heldObject.GetComponent<PickUpObject>();
    ...
    private void PlaceObject() {
        ...
        heldObject.GetComponent<PickUpObject>().SetCurrentState(PickUpObject.State.IDLE);
    ...
    private void ThrowObject() {
        ...
        heldObject.GetComponent<PickUpObject>().SetCurrentState(PickUpObject.State.THROWN);
